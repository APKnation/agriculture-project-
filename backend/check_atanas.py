#!/usr/bin/env python
"""
Script to check if user 'atanas' exists and test credentials
"""
...
def check_user():
    """Check if user 'atanas' exists and test password"""
    print("🔍 Checking user 'atanas'...")
    print("=" * 50)
    ...
    try:
        ...
        print("❌ User 'atanas' does NOT exist in database!")
